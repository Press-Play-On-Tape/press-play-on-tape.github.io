...
<div id="wrapper">
	...
	<div id="content">
		...
		<img src="images/pokitto/minirogue/pokitto_minirogue_28.gif" width="480" />		
<br/><br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_00.png" width="480" />
<br/>
<br/>
<h1>Mini Rogue</h1>
...
<table>
<tr><td><img src="images/pokitto/minirogue/pokitto_minirogue_01.png" width="32" />&nbsp;&nbsp;&nbsp;&nbsp;</td><td>Rank:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>As you accumulate experience (XP) in the dungeon your rank. This will assist in your ability to fight the various monsters you will find in the dungeon, refer Monster Card and Boss Monster Card below.</td</tr>
<tr><td><img src="images/pokitto/minirogue/pokitto_minirogue_02.png" width="32" /></td><td>XP:</td><td>You will be rewarded XP as you defeat monsters or stumble across treasures in the  dungeon.</td</tr>
<tr><td><img src="images/pokitto/minirogue/pokitto_minirogue_03.png" width="32" /></td><td>HP:</td><td>Your health will take a beating as you battle monsters but you can top it up when you visit a Merchant or discover it hidden in the dungeon.</td</tr>
<tr><td><img src="images/pokitto/minirogue/pokitto_minirogue_04.png" width="32" /></td><td>Armour:</td><td>Armour will protect you when you inevitably encounter a monster in the dungeon. Armour can be bought at the Merchant or destroyed through acid rain.</td</tr>
<tr><td><img src="images/pokitto/minirogue/pokitto_minirogue_05.png" width="32" /></td><td>Gold:</td><td>You can buy your way out of trouble with enough gold. Gain extra gold be killing monsters and finding treasures.</td</tr>
<tr><td><img src="images/pokitto/minirogue/pokitto_minirogue_06.png" width="32" /></td><td> Food:</td><td> Food is essential to life in the dungeon. You will need consume a food ration every time you complete an area in the dungeon. If you have no food, you will lose 3 HP tipoints and potentially die.</td</tr>
</table>                               
</p>
</details>
...
<p>
As you become more experienced fighting monsters in the dungeon, your XP points will increase. Once you have accumulated enough XP points, your rank will be upgraded (to a maximum of three). Increased rank provides you with additional weapons when fighting the dungeon’s monsters. Refer to the section <b>Monster Card</b> and <b>Boss Monster Card</b> below.
</p>
<table>
...
<img src="images/pokitto/minirogue/pokitto_minirogue_07.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_08.png" width="230" />
<br/>
<p>
...
Once you have completed the last room in an area you must consume 1 Food before proceeding to the next area or level. If at the end of the level, you have no food you will starve and lose 3 HP points and if you run out of HP points you will possibly die!
</p><p>
The dungeon levels and area are laid out as shown below:
</p>
<img src="images/pokitto/minirogue/pokitto_minirogue_09.jpeg" width="230" />
<br/>
</details>
...
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_10.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_11.png" width="230" />
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_12.png" width="230" />
<br/>
<p>
...
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_13.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_14.png" width="230" />
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_15.png" width="230" />
<br/>
<p>
...
<p>
Roll a at least one five or six and you will be able to choose your winnings. Scroll between the options using the <b>Left</b> and <b>Right Buttons</b> and select your choice using the <b>A Button</b>.
</p>
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_16.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_17.png" width="230" />
<br/>
<p>
...
<img src="images/pokitto/minirogue/pokitto_minirogue_18.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_19.png" width="230" />
<br/>
<p>
Dungeon means danger, and danger sometimes means traps. Many adventurers perished not through combat, but through lack of scrutiny. You can avoid a trap if you are sufficiently skilled. This is determined by a roll of a die – if the result is less than or equal to your rank you can skip the trap. If not, you must endure one of the following traps:
</p>
...
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_20.png" width="230" />
<br/>
<p>
...
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_21.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_22.png" width="230" />
<br/>
<p>
...
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_23.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_24.png" width="230" />
<br/>
<p>
...
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_25.png" width="230" />&nbsp;&nbsp;
<img src="images/pokitto/minirogue/pokitto_minirogue_26.png" width="230" />
<br/>
<p>
...
<br/>
<img src="images/pokitto/minirogue/pokitto_minirogue_27.png" width="230" />
<br/>
<p>
You are rewarded points for every area you enter, boss monster’s you kill and the collection of goodies along the way. To reset the scores, hold down the <b>Up Button</b> and <b>Down Buttons</b> simultaneously for about 5 seconds while on this screen.
</p>
</details>
<br/>			
			</div>
